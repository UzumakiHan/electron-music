                ...
                <div :class="isCurSong(item, index)" v-for="(item, index) in list" :key="item.id">
                    ...
                    <div class="columnSong songlist-name">
                        ...
                        <template v-if="typeSize !== 'mini'">
                            <router-link class="mv-name" :to="{ path: '/mvlist/mv', query: { id: item.mvId } }"
                                v-if="item.mvId">
                    ...
                    <div class="columnSinger songlist-singer">
                        ...
                        <router-link :to="{ path: '/singer', query: { id: author.id } }" class="song_name"
                            v-for="(author, k) in item.singer" :key="author.name">{{ k !== 0 ? ' / ' + author.name :
                                author.name }}</router-link>
                    </div>
                    <div class="columnAlbum" v-if="typeSize !== 'mini'">
                        <router-link class="songlist-album" :to="{ path: '/album', query: { id: item.album.id } }"
                            v-if="item.album">{{ item.album.name }}</router-link>
                    </div>
                    <div class="columnTime">
                        ...
                        <div class="songlist-oper">
                            <i class="iconfont icon-add" title="添加到列表" v-if="typeSize !== 'mini'"
                            ...
                            <i class="iconfont icon-del" title="删除" v-if="typeSize === 'mini'"
