<template>
    <div class="play-bar-main">
        <transition name="fade-bar">
            <Bar v-if="barType == 'Bar'" @changeMini="changeMini" @audioHandler="playSongStates"
                @playAudioMode="playAudioMode" @setvolumeProgress="setvolumeProgress" @setAudioProgress="setAudioProgress"
                @setVolumeHandler="setVolumeHandler" />
        </transition>
        <transition name="fade-mini">
            <MiniBar v-if="barType == 'MiniBar'" @changeMini="changeMini" @audioHandler="playSongStates"
                @playAudioMode="playAudioMode" @setAudioProgress="setAudioProgress" />
        </transition>
        <AudioBox ref="audioRef" @setCurrentTime="setCurrentTime" />
    </div>
</template>
